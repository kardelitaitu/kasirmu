...
/*
last audited 25-07-26 by RSA-Agent (kasirmu-core slice C3: settings deep read)
...
/// reaches `kasirmu_core::settings::keys::*`. Pointing a lane at the funnel is
...
// ── Feature flags (kasirmu-core specific) ─────────────────────────────────
