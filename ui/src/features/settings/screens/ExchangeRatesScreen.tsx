//! ExchangeRatesScreen — blank Settings screen scaffold (settings rebuild).
//!
//! Migration provenance (orchestrator contract, settings-screens phase):
//! Content moves here from `features/currency/ExchangeRateScreen.tsx`.
...
/** Placeholder for Settings → Exchange Rates. */
