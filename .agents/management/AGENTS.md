...
<!-- Audit stamp: 2026-09-04 · DSH · status: ACCURATE · version lock: 0.0.40 · 7 pre-commit gates (count corrected 2026-09-13, when the cargo fmt step was removed) · conventional commits enforced -->
...
| **Version Lock** | **Version is locked at `0.0.40`. NEVER modify version numbers.** | Do not bump version in `Cargo.toml`, `package.json`, `tauri.conf.json`, etc. |
