# shared-ui/locales/products.ftl — Product management, lookup, variants
...
product-mgmt-error-save = Failed to save product
product-mgmt-error-invalid-price = Price must be a valid non-negative number
