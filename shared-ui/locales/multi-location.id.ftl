...
topology-apply-confirm-note-label = Apa yang berubah?
topology-apply-confirm-note-optional = opsional
topology-apply-confirm-note-placeholder = mis. Membuka counter Pos Kota; memindahkan Gudang ke routing ruang belakang
topology-apply-confirm-note-count = { $count } / { $max }
topology-apply-confirm-pin-label = Masukkan PIN Anda untuk mengonfirmasi
topology-apply-confirm-pin-placeholder = PIN
topology-apply-confirm-pin-error = PIN salah. Silakan coba lagi.
topology-apply-confirm-pin-remember = Ingat PIN untuk sesi ini
topology-apply-confirm-cancel = Batal
topology-apply-confirm-apply = Terapkan
topology-apply-confirm-verifying = Memverifikasi…
topology-apply-confirm-scope-session = Toko sesi
topology-apply-confirm-scope-target = Toko target
topology-apply-confirm-scope-mismatch = Toko sesi berbeda dari toko Branch Location. CRUD workspace akan menarget toko Branch Location.

# ── ADR #46: browser riwayat deploy ────────────────────────────
topology-history-open = Riwayat deploy
...
topology-rev-browser-pruned = Snapshot dihapus — catatan tetap ada
topology-rev-browser-pin = Sematkan deploy ini
topology-rev-browser-unpin = Lepas sematan deploy ini
topology-rev-browser-detail-title = Revisi { $revision }
topology-rev-browser-deflated-body = Deploy ini tercatat tetapi grafiknya dihapus oleh retensi, sehingga tidak dapat dipratinjau atau dipulihkan. Diterbitkan oleh { $by }.
topology-rev-browser-not-found = Revisi ini tidak lagi tersedia.
topology-rev-browser-identical = Konfigurasi sama dengan sekarang
...
topology-apply-permission-tooltip = Menerapkan perubahan topologi memerlukan izin topology:write.
topology-readonly-note = Mode hanya-baca — menyimpan perubahan topologi memerlukan izin topology:write.
topology-rename-permission-error = Mengganti nama item topologi memerlukan izin topology:write.
...
topology-empty-state-body = Klik alat di palet (atau tekan 1–4 dengan kanvas dalam fokus) untuk menambahkan node. Hubungkan node dengan soket port di setiap kartu.
...
topology-compare-open = Bandingkan
topology-compare-title = Bandingkan Cabang
topology-compare-close = Tutup
topology-compare-other-label = Bandingkan dengan
topology-compare-loading = Membandingkan…
topology-compare-load-error = Gagal membandingkan cabang
topology-compare-counts = { $onlyInCurrent } workspace hanya di sini · { $onlyInOther } hanya di { $otherBranch } · { $differ } berbeda
topology-compare-only-here = Hanya di sini: { $names }
...
topology-rack-delete-empty = Pilih node atau kabel untuk dihapus
topology-export-desc = Unduh sebagai JSON
topology-import-desc = Muat dari berkas JSON
...
topology-selection-announce = { $name } dipilih
topology-selection-wire-announce = Koneksi dipilih
topology-selection-clear-announce = Pilihan dibersihkan
topology-context-rename = Ganti nama
topology-action-active = Aktif
topology-action-disabled = Nonaktif
topology-action-properties = Properti
topology-action-disconnect = Putuskan
...
topology-apply-blocked = Penerapan diblokir — { $count } masalah untuk diperbaiki di panel
...
topology-node-stock-wire-hint = Hubungkan Stock Out dari workspace atau output Gudang lain ke Stock In Gudang ini.
...
topology-inspector-section-identity = Identitas
topology-inspector-section-location = Branch Location
topology-inspector-section-warehouse = Gudang
topology-inspector-section-actions = Aksi
topology-inspector-address = Alamat
topology-inspector-address-placeholder = Jalan, kota
topology-inspector-currency = Mata Uang
topology-inspector-timezone = Zona Waktu
topology-inspector-timezone-placeholder = Pilih zona waktu…
topology-inspector-timezone-asia-jakarta = Asia/Jakarta (WIB, +07:00)
topology-inspector-timezone-asia-makassar = Asia/Makassar (WITA, +08:00)
topology-inspector-timezone-asia-jayapura = Asia/Jayapura (WIT, +09:00)
topology-inspector-tax-id = NPWP
topology-inspector-tax-id-placeholder = contoh: 1234567890
topology-inspector-device-type = Tipe Perangkat
topology-inspector-device-address = Alamat Koneksi
...
topology-warehouse-quota = Gudang: { $count } / { $limit }
topology-warehouse-quota-over = Gudang melewati batas paket: { $count } / { $limit }
topology-warehouse-quota-unlimited = Gudang: { $count } (tanpa batas)
topology-overlap-badge = Kartu bertumpuk
topology-tier-capacity-notice = Angka kapasitas Gudang tersimpan tetapi tidak diberlakukan pada paket Anda saat ini — tingkatkan ke Pro untuk menggunakan batas kapasitas.
...
topology-typedesc-store-pos = Terminal kasir untuk transaksi penjualan dan checkout ritel
topology-typedesc-restaurant-pos = Terminal pemesanan restoran dengan meja dan tiket dapur
topology-typedesc-kds = Layar dapur untuk persiapan dan perutean pesanan
topology-typedesc-warehouse = Penyimpanan inventaris untuk pengurangan stok dan transfer cabang
topology-typedesc-admin = Terminal administratif back-office dan konfigurasi
topology-typedesc-store = Root lokasi toko cabang fisik
topology-typedesc-hardware = Perangkat keras periferal terhubung ke terminal
...
topology-warehouse-capacity-desc = Jumlah maksimal item yang dapat ditampung Gudang ini
...
topology-warehouse-stock-desc = Item yang saat ini tersimpan di Gudang ini
...
topology-migration-title = Migrasi koneksi lama
topology-migration-description = Koneksi lama ini tidak dapat diidentifikasi dengan aman. Pilih arti setiap koneksi agar diagram dapat diterapkan. Koneksi tanpa arti yang kompatibel harus dihapus dan dibuat ulang menggunakan port berlabel.
topology-migration-select-aria = Koneksi dari { $from } ke { $to }
topology-migration-delete = Hapus koneksi ini
topology-migration-later = Nanti
topology-migration-resolve = Selesaikan
topology-migration-announce = Koneksi lama diselesaikan
...
topology-validation-warehouse-at-capacity = Gudang sudah mencapai atau melebihi kapasitas — alihkan stok ke tempat lain terlebih dahulu.
