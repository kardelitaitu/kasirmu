//! Consume a pending restore request at boot, before anything opens the database (C8, slice S4a).
//!
...
//! This module is the consumer. [`consume_pending_restore`] runs from the desktop setup
