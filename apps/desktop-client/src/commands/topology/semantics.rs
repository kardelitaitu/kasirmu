...
//! module is the re-export shim. Both `kasirmu_core::topology` blocks stay here
...
// live in the bridge and import them from kasirmu_core directly. Both builds were
...
#[cfg(test)]
pub(crate) use kasirmu_core::topology::{
