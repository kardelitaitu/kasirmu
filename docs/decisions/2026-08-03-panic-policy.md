...
> **total 136 / invariant_annotated 132 / recoverable 4** (all figures as at 15:57; superseded by
> the closure block below, which is the current state). Both source files were clean in
