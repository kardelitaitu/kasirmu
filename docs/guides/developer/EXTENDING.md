...
- it serves **one store's database at a time** — by default the
  **primary store**, the same `store-{id}.sqlite` file the register
  ...
  at `apps/desktop-tauri/src/local_api.rs:95` runs
