...
- **`settings_changed_sink`** [not an IPC command] — A plain helper at `apps/desktop-tauri/src/commands/sync.rs:210`, used by the wiring at `:366`. The callable surface is `settings_changed_sink_scoped` at `:811`.
