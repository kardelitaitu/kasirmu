...
**Index — the eighteen items below, by what they actually ask (added 2026-09-15; nothing below is renumbered, rewritten or re-decided).**
...
- **13 — what a Free tenant must audit** on a licence-tier refusal at the shipping profile, ruled before the next tag.
