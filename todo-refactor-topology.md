...
- [x] Divide the remaining editor into explicit responsibility groups without changing code: (division done in the Phase-1 slices; each group now has a named module or a mapped seam — 2026-09-09 accuracy review records the groups still inline)
  ...
  - [ ] Touch gestures, pan, zoom, and viewport persistence. (Extracted — `nodeTopologyEditorTouch.ts` cfad63603, `nodeTopologyEditorViewport.ts` 2fa4cbfe1, view-prefs hook 29300f8ea. The claim now holds on the tree; left unticked because this pass was authorized for the Phase 5 / Phase 6 / checklist sync only, so Phase 1 boxes go to their own re-audit — recorded in the W3 entry rather than banked here.)
  ...
  - [ ] Rename, inspector editing, templates, import/export, and clipboard. (Extracted — rename c877b1e6c / ffe5e448d, inspector drawer 5c7739327 with branch fields a7b0c5051, templates + import/export 0b2d86e72, clipboard 5842e2d81, add-node c6cb86e78. Unticked for the same authorization reason as the box above; the "Inline" wording was simply false.)
