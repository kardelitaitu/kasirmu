...
mkdir -p ui/src/features/kds ui/src/api apps/desktop-client/src .circleci docs
...
stage_and_run "staged Rust + CI + docs" apps/desktop-client/src/lib.rs .circleci/config.yml docs/x.md
